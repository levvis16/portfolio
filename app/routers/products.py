...
async def get_all_products(
    ...
    if category_id is not None:
        filters.append(ProductModel.category_id == category_id)  # type: ignore
    if min_price is not None:
        filters.append(ProductModel.price >= min_price)  # type: ignore
    if max_price is not None:
        filters.append(ProductModel.price <= max_price) # type: ignore
    if in_stock is not None:
        filters.append(ProductModel.stock > 0 if in_stock else ProductModel.stock == 0) # type: ignore
    if seller_id is not None:
        filters.append(ProductModel.seller_id == seller_id) # type: ignore
